...
export default class ChangePassword extends React.Component {
  ...
  render() {
    return (
      <div>
        <h1 className="heading111">Password Changing Information</h1>
        <hr />
        <form onSubmit={this.handleChangePassword} onReset={this.resetInput}>
          <label htmlFor="id_prevPassword">Previous Password</label>
          <input type="password" id="id_prevPassword" name="prevPassword" />
          <br />
          <label htmlFor="id_newPassword">New Password</label>
          <input type="password" id="id_newPassword" name="newPassword" />
          <br />
          <label htmlFor="id_retypePassword">Retype Password</label>
          <input type="password" id="id_retypePassword" name="retypePassword" />
          <br />
